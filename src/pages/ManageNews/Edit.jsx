...
import {getBranchList, updateBranch} from "../../../context/actions";
import {GlobalContext} from "../../../context/GlobalState";
import {removeEndSpaces} from "../../../helpers";
import FormEditClone from "./FormEditClone";

const Edit = ({isOpen, onCloseModal}) => {
  ...
  const onHandleSubmit = (e) => {
    ...
    const errorAction = () => {
      toast("Failed update!", {type: "error"});
    };
    updateBranch(dataBranch.id, dataBranch, successAction, errorAction)();
  };
